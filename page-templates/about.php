...
<div class="order-1 order-md-0 col-12 col-md-8 p-5">
    <div class="the_content">
        ...
        <div class="row mt-4">
            ...
            <div id="about_resume" class="col-9 scroll-snap-y">
                <section class="hellow mb-4">
